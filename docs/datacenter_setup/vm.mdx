...
## 4. (Optional) Enable Other Virtualization Options
...
Additionally, you may need to add `intel_iommu=on` or `amd_iommu=on` options depending on your system.
