...
When launching the desktop app for the first time you'll be asked for credentials.
Alternatively, credentials can be configured in the config file. Location depends
