...
<Tabs groupId="operating-systems">
  <TabItem value="win" label="Windows">
    <a href="https://storage.googleapis.com/fair-compute-releases/stable/fair-desktop/windows/x86_64/fair-desktop-x86_64-windows-0.19.0.msi">Download Fair Desktop Installer</a>
    <br/>
    <a href="https://storage.googleapis.com/fair-compute-releases/stable/fair/windows/x86_64/fair-x86_64-windows-0.19.0.zip">Download Fair CLI</a>
  </TabItem>
