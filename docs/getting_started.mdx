...
To configure credentials launch the app, right-click on the tray icon and click
change credentials. Alternatively, edit the config manually. Location depends
on your operating system.
<Tabs groupId="operating-systems">
    <TabItem value="win" label="Windows">
        Windows **ADD LINK**
        <pre>C:\Users\[user_name]\AppData\Roaming\Fair Compute\credentials.yml</pre>
    </TabItem>
    <TabItem value="mac" label="Mac">
        <pre>/Users/[user_name]/Library/Application Support/rs.fair-compute/credentials.yml</pre>
    </TabItem>
    <TabItem value="linux" label="Linux">
...
Download the latest command line client. Command line client is used to communicate with
the Fair server and send jobs to the provider application on one of your machines.
<Tabs groupId="operating-systems">
    <TabItem value="win" label="Windows">
        Windows **ADD LINK**
    </TabItem>
...
If you need to see a bit more details, add `-v` flag.
