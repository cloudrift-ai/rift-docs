---
sidebar_position: 2
title: CloudRift Desktop App Installation and Setup
description: Install and configure CloudRift Desktop App to run workloads on your own machines. Complete guide for Windows, Mac, and Linux with Docker integration.
keywords: [CloudRift Desktop, desktop app, local workloads, Docker integration, rift-desktop, personal computing, laptop GPU, desktop computing, CloudRift installation]
---
